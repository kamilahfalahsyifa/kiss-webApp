...
<div class="bg-white rounded-2xl shadow-md p-4 sm:p-6 border border-gray-100">
    <h3 class="text-base sm:text-lg font-bold text-gray-800 mb-4 sm:mb-6">Edit Replacement Activity</h3>

    @if($errors->any())
    <div class="mb-4 sm:mb-6 p-4 bg-red-50 border border-red-200 rounded-xl text-red-900 text-sm">
    ...
    <form method="POST" action="{{ route('mekanik.activities.update', $activity->id) }}" enctype="multipart/form-data">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
            ...
            <div>
                ...
                <input type="text" name="wo" value="{{ old('wo', $activity->wo) }}" placeholder="e.g. 12345678"
            ...
            <div>
                ...
                <input type="text" name="reservasi" value="{{ old('reservasi', $activity->reservasi) }}" placeholder="e.g. 12345678"
