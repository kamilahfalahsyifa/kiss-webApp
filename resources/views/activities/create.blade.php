...
<div class="bg-white rounded-2xl shadow-md p-4 sm:p-6 border border-gray-100">
    ...
    <form method="POST" action="{{ route('mekanik.activities.store') }}" enctype="multipart/form-data">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
            ...
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-2">WO</label>
                <input type="text" name="wo" value="{{ old('wo') }}" placeholder="e.g. 12345678"
            ...
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-2">Reservasi</label>
                <input type="text" name="reservasi" value="{{ old('reservasi') }}" placeholder="e.g. 12345678"
